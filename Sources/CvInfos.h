...
protected:
	...
	IDValueMap<UnitCombatTypes, int> m_aFlankingStrengthbyUnitCombatTypeChange;
	IDValueMap<TerrainTypes, int> m_aWithdrawOnTerrainTypesChange;
	IDValueMap<FeatureTypes, int> m_aWithdrawOnFeatureTypesChange;
	IDValueMap<UnitCombatTypes, int> m_aWithdrawVSUnitCombatChangeTypes;
	IDValueMap<UnitCombatTypes, int> m_aPursuitVSUnitCombatChangeTypes;
	IDValueMap<UnitCombatTypes, int> m_aRepelVSUnitCombatChangeTypes;
	IDValueMap<UnitCombatTypes, int> m_aKnockbackVSUnitCombatChangeTypes;
	IDValueMap<UnitCombatTypes, int> m_aPunctureVSUnitCombatChangeTypes;
	IDValueMap<UnitCombatTypes, int> m_aArmorVSUnitCombatChangeTypes;
	IDValueMap<UnitCombatTypes, int> m_aDodgeVSUnitCombatChangeTypes;
	IDValueMap<UnitCombatTypes, int> m_aPrecisionVSUnitCombatChangeTypes;
	IDValueMap<UnitCombatTypes, int> m_aCriticalVSUnitCombatChangeTypes;
	IDValueMap<UnitCombatTypes, int> m_aRoundStunVSUnitCombatChangeTypes;
	IDValueMap<UnitCombatTypes, int> m_aTrapDisableUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aTrapAvoidanceUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aTrapTriggerUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aAIWeightbyUnitCombatTypes;
	IDValueMap<PropertyTypes, int> m_aAidChanges;
	IDValueMap<TerrainTypes, int> m_aTerrainWorkRateModifierChangeTypes;
	IDValueMap<FeatureTypes, int> m_aFeatureWorkRateModifierChangeTypes;
	IDValueMap<BuildTypes, int> m_aBuildWorkRateModifierChangeTypes;
	IDValueMap<InvisibleTypes, int> m_aVisibilityIntensityChangeTypes;
	IDValueMap<InvisibleTypes, int> m_aInvisibilityIntensityChangeTypes;
	IDValueMap<InvisibleTypes, int> m_aVisibilityIntensityRangeChangeTypes;
	IDValueMap<PromotionLineModifier, int> m_aAfflictionFortitudeChangeModifiers;
...
public:
	...
	int getControlPoints() const;
	int getCommandRange() const;
	const TCHAR* getClassicalArtDefineTag(int i, UnitArtStyleTypes eStyle) const;
	void setClassicalArtDefineTag(int i, const TCHAR* szVal);
	const TCHAR* getRennArtDefineTag(int i, UnitArtStyleTypes eStyle) const;
	void setRennArtDefineTag(int i, const TCHAR* szVal);
	const TCHAR* getIndustrialArtDefineTag(int i, UnitArtStyleTypes eStyle) const;
	void setIndustrialArtDefineTag(int i, const TCHAR* szVal);
	const TCHAR* getFutureArtDefineTag(int i, UnitArtStyleTypes eStyle) const;
...
protected:
	...
	IDValueMap<UnitCombatTypes, int> m_aFlankingStrengthbyUnitCombatType;
	IDValueMap<TerrainTypes, int> m_aWithdrawOnTerrainTypes;
	IDValueMap<FeatureTypes, int> m_aWithdrawOnFeatureTypes;
	IDValueMap<UnitCombatTypes, int> m_aWithdrawVSUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aPursuitVSUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aRepelVSUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aKnockbackVSUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aPunctureVSUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aArmorVSUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aDodgeVSUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aPrecisionVSUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aCriticalVSUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aRoundStunVSUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aTrapDisableUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aTrapAvoidanceUnitCombatTypes;
	IDValueMap<UnitCombatTypes, int> m_aTrapTriggerUnitCombatTypes;
	IDValueMap<InvisibleTypes, int> m_aVisibilityIntensityTypes;
	IDValueMap<InvisibleTypes, int> m_aInvisibilityIntensityTypes;
	IDValueMap<InvisibleTypes, int> m_aVisibilityIntensityRangeTypes;
	IDValueMap<TerrainTypes, int> m_aTerrainWorkRateModifierTypes;
	IDValueMap<FeatureTypes, int> m_aFeatureWorkRateModifierTypes;
	IDValueMap<BuildTypes, int> m_aBuildWorkRateModifierTypes;
#ifdef OUTBREAKS_AND_AFFLICTIONS
	IDValueMap<PropertyTypes, int> m_aAidChanges;
#endif
};
...
public:
	...
	const TCHAR* getModelFileKey() const;
...
//	bool* m_pabFreePromotionUnitCombat;
	...
	IDValueMap<BonusTypes, int, 0> m_aBonusHappinessChanges;
	//TB Traits mods end
};
...
protected:
	...
	IDValueMap<InvisibleTypes, int> m_aInvisibilityIntensityChangeTypes;
	IDValueMap<InvisibleTypes, int> m_aVisibilityIntensityRangeChangeTypes;
	IDValueMap<InvisibleTypes, int> m_aVisibilityIntensitySameTileChangeTypes;
	IDValueMap<TerrainTypes, int> m_aTerrainAttackChangeModifiers;
	IDValueMap<TerrainTypes, int> m_aTerrainDefenseChangeModifiers;
	IDValueMap<TerrainTypes, int> m_aTerrainWorkChangeModifiers;
	IDValueMap<BuildTypes, int> m_aBuildWorkChangeModifiers;
	IDValueMap<FeatureTypes, int> m_aFeatureAttackChangeModifiers;
	IDValueMap<FeatureTypes, int> m_aFeatureDefenseChangeModifiers;
	IDValueMap<FeatureTypes, int> m_aFeatureWorkChangeModifiers;
	IDValueMap<UnitCombatTypes, int> m_aUnitCombatChangeModifiers;
	IDValueMap<UnitCombatTypes, int> m_aFlankingStrengthbyUnitCombatTypeChange;
	IDValueMap<UnitCombatTypes, int> m_aWithdrawVSUnitCombatTypeChange;
	IDValueMap<UnitCombatTypes, int> m_aPursuitVSUnitCombatTypeChange;
	IDValueMap<UnitCombatTypes, int> m_aRepelVSUnitCombatTypeChange;
	IDValueMap<UnitCombatTypes, int> m_aKnockbackVSUnitCombatTypeChange;
	IDValueMap<UnitCombatTypes, int> m_aPunctureVSUnitCombatTypeChange;
	IDValueMap<UnitCombatTypes, int> m_aArmorVSUnitCombatTypeChange;
	IDValueMap<UnitCombatTypes, int> m_aDodgeVSUnitCombatTypeChange;
	IDValueMap<UnitCombatTypes, int> m_aPrecisionVSUnitCombatTypeChange;
	IDValueMap<UnitCombatTypes, int> m_aCriticalVSUnitCombatTypeChange;
	IDValueMap<UnitCombatTypes, int> m_aRoundStunVSUnitCombatTypeChange;
	IDValueMap<UnitCombatTypes, int> m_aTrapAvoidanceUnitCombatTypes;
#ifdef OUTBREAKS_AND_AFFLICTIONS
	IDValueMap<PromotionLineModifier, int> m_aAfflictionFortitudeChangeModifiers;
	IDValueMap<PropertyTypes, int> m_aAidChanges;
