...
public:
	...
	// derived methods
	virtual void destroy(CvFeature*& pObj, bool bSafeDelete=true) { CvGlobals::getInstance().getDLLIFace()->getSymbolIFace()->destroy((CvSymbol*&)pObj, bSafeDelete); }
	virtual void Hide(CvFeature* pObj, bool bHide) { CvGlobals::getInstance().getDLLIFace()->getSymbolIFace()->Hide((CvSymbol*)pObj, bHide); }
	virtual bool IsHidden(CvFeature* pObj) { return CvGlobals::getInstance().getDLLIFace()->getSymbolIFace()->IsHidden((CvSymbol*)pObj); }
	virtual void updatePosition(CvFeature* pObj) { CvGlobals::getInstance().getDLLIFace()->getSymbolIFace()->updatePosition((CvSymbol*)pObj); }
};
...
public:
	...
	// derived methods
	virtual void destroy(CvRoute*& pObj, bool bSafeDelete=true) { CvGlobals::getInstance().getDLLIFace()->getSymbolIFace()->destroy((CvSymbol*&)pObj, bSafeDelete); }
	virtual void Hide(CvRoute* pObj, bool bHide) { CvGlobals::getInstance().getDLLIFace()->getSymbolIFace()->Hide((CvSymbol*)pObj, bHide); }
	virtual bool IsHidden(CvRoute* pObj) { return CvGlobals::getInstance().getDLLIFace()->getSymbolIFace()->IsHidden((CvSymbol*)pObj); }
	virtual void updatePosition(CvRoute* pObj) { CvGlobals::getInstance().getDLLIFace()->getSymbolIFace()->updatePosition((CvSymbol*)pObj); }
...
public:
	...
	// derived methods
	virtual void destroy(CvRiver*& pObj, bool bSafeDelete=true) { CvGlobals::getInstance().getDLLIFace()->getRouteIFace()->destroy((CvRoute*&)pObj, bSafeDelete); }
	virtual void Hide(CvRiver* pObj, bool bHide) { CvGlobals::getInstance().getDLLIFace()->getRouteIFace()->Hide((CvRoute*)pObj, bHide); }
	virtual bool IsHidden(CvRiver* pObj) { return CvGlobals::getInstance().getDLLIFace()->getRouteIFace()->IsHidden((CvRoute*)pObj); }
	virtual void updatePosition(CvRiver* pObj) { CvGlobals::getInstance().getDLLIFace()->getRouteIFace()->updatePosition((CvRoute*)pObj); }
};
