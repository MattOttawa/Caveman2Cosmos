...
#define DECLARE_GET_METHOD(VAR, dataType) \
	dataType get##VAR() const { return m_##VAR; }

	FOR_EACH_GLOBAL_DEFINE_INT(DECLARE_GET_METHOD, int)
	FOR_EACH_GLOBAL_DEFINE_FLOAT(DECLARE_GET_METHOD, float)
	FOR_EACH_SIZE_T_GLOBAL_DEFINE(DECLARE_GET_METHOD, int)

#define DECLARE_BOOL_GET_METHOD(VAR, dataType) \
	dataType is##VAR() const { return m_##VAR; }

	FOR_EACH_GLOBAL_DEFINE_BOOL(DECLARE_BOOL_GET_METHOD, bool)
...
#define DECLARE_MEMBER_VAR(VAR, dataType) \
	dataType m_##VAR;

	FOR_EACH_GLOBAL_DEFINE_INT(DECLARE_MEMBER_VAR, int)
	FOR_EACH_GLOBAL_DEFINE_BOOL(DECLARE_MEMBER_VAR, bool)
	FOR_EACH_GLOBAL_DEFINE_FLOAT(DECLARE_MEMBER_VAR, float)
	FOR_EACH_SIZE_T_GLOBAL_DEFINE(DECLARE_MEMBER_VAR, int)
