...
void CyInfoPythonInterface1()
{
	...
	python::class_<CvUnitInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvUnitInfo", python::no_init)
		...
		.def("getPrereqOrBuildings", &CvUnitInfo::getPrereqOrBuildings, python::return_value_policy<python::reference_existing_object>())
	...
	python::class_<CvBuildingInfo, python::bases<CvInfoBase, CvScalableInfo>, boost::noncopyable>("CvBuildingInfo", python::no_init)
		...
		.def("getBonusHealth", &CvBuildingInfo::getBonusHealth, python::return_value_policy<python::reference_existing_object>())
		.def("getBonusHappinessChanges", &CvBuildingInfo::getBonusHappinessChanges, "int (int i)")
		.def("getBonusHappiness", &CvBuildingInfo::getBonusHappiness, python::return_value_policy<python::reference_existing_object>())
		...
		.def("getPrereqOrBuildings", &CvBuildingInfo::getPrereqOrBuildings, python::return_value_policy<python::reference_existing_object>())
