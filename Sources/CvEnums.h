...
enum SupportPositionTypes
{
	NO_SUPPORT_POSITION = -1,
	SUPPORT_POSITION_FRONT,
	SUPPORT_POSITION_SHORT_RANGE,
	SUPPORT_POSITION_MEDIUM_RANGE,
	SUPPORT_POSITION_LONG_RANGE,
	SUPPORT_POSITION_FLANK,

	NUM_SUPPORT_POSITION_TYPES,

	MAX_SUPPORT_UNITS = NUM_SUPPORT_POSITION_TYPES * 2
};
