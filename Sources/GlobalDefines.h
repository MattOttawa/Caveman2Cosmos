...
#define DO_FOR_EACH_INT_GLOBAL_DEFINE(DO) \
	...
	DO(int, USE_CANNOT_SPREAD_RELIGION_CALLBACK) \
...
#define DO_FOR_EACH_INFO_TYPE(DO) \
	...
	DO(MapTypes, MAPCATEGORY_SUBTERRANEAN) \
	DO(MapTypes, MAPCATEGORY_AQUATIC) \
	DO(MapTypes, MAPCATEGORY_CISLUNAR) \
	DO(MapTypes, MAPCATEGORY_LUNAR) \
	DO(MapTypes, MAPCATEGORY_SOLAR_SYSTEM) \
	DO(MapTypes, MAPCATEGORY_MARTIAN) \
	DO(MapTypes, MAPCATEGORY_VENUSIAN) \
	DO(MapTypes, MAPCATEGORY_JOVIAN) \
	DO(MapTypes, MAPCATEGORY_TITANIC) \
	DO(MapTypes, MAPCATEGORY_INTERSTELLAR) \
	DO(MapTypes, MAPCATEGORY_PLASMA) \
	DO(MapTypes, MAPCATEGORY_GALACTIC) \
	DO(MapTypes, MAPCATEGORY_MILKY_WAY) \
	DO(MapTypes, MAPCATEGORY_UNIVERSAL) \
	DO(MapTypes, MAPCATEGORY_DISTANT) \
	DO(MapTypes, MAPCATEGORY_HYPERSPACE) \
