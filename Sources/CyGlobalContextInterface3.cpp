...
void CyGlobalContextPythonInterface3(python::class_<CyGlobalContext>& x)
{
	...
	x
		...
		.def("getPlayerOptionInfo", &CyGlobalContext::getPlayerOptionInfo, python::return_value_policy<python::reference_existing_object>(), "(PlayerOptionsInfoID) - PlayerOptionsInfo for PlayerOptionsInfo")
		...
		.def("getGraphicOptionInfo", &CyGlobalContext::getGraphicOptionInfo, python::return_value_policy<python::reference_existing_object>(), "(GraphicOptionsInfoID) - GraphicOptionsInfo for GraphicOptionsInfo")
